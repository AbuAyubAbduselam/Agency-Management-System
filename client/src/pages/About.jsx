    ...
    <Layout>
      ...
      <Content className="min-h-screen mx-10 my-10">
        ...
        >
          ...
          በእውቀታቸው፣በገንዘባቸው፣በጉልበታቸው እንዲሁም በዳእዋቸው ሲያገለግሉ እና በዓለማዊው ትምህርታቸው ውጤታማ ሆነው
          ማየት፣በተጨማሪም ከ 2017 ጀምሮ ማእከሉን ለ 500 ተማሪዎች ዝግጁ ማድረግ 
        </Card>
        ...
        <Card
          ...
          className="my-4 text-2xl"
        >
          ወቅቱን ያገናዘቡ ዘመኑን ለመቅደም በሚያስችል መልኩ   ዘመናዊ የትምህርት ስርዓት ከአገረሰብ ወግ እና ልማዶች
          ጋር በማዋሃድ የበፊቱ ሳይኖር የአሁኑ ሊኖር ስለማይችል ከሁሉ በፊት የቀድሞ ትውልዶች ላቆዩልን ጠቃሚ  እሴቶች
        ...
        <Card
          ...
          className="my-4 text-2xl"
        >
          በኢስላማዊ ባህሪ የታነጹ ሕጻናትና ወጣቶች ቁርአንን በእይታ በሂፍዝ በተጅዊድ በማዳረስ ተተኪዎችን በማፍራት
          ተምሳሌት መሆን
        </Card>
