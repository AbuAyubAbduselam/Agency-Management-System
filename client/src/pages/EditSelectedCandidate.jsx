...
const EditCandidate = () => {
 ...
 const onFinish = async (values) => {
  ...
  // ✅ Add delete flags if user removed image
  if (avatarFileList.length === 0 && candidate.avatar) {
    formData.append("deleteAvatar", "true");
  }
  if (fullPhotoFileList.length === 0 && candidate.fullSizePhoto) {
    formData.append("deleteFullSizePhoto", "true");
  }
  if (passportScanFileList.length === 0 && candidate.passportScan) {
    formData.append("deletePassportScan", "true");
  }
  ...
  return (
    <Wrapper>
      ...
      {/*     <Form.Item label="Contract Date" name="contractDate"><DatePicker format="DD/MM/YYYY" style={{ width: "100%" }} /></Form.Item>
          ...
          <Form.Item label="Tasheer Date & Time" name="tasheerDate"><DatePicker showTime format="DD/MM/YYYY HH:mm A" style={{ width: "100%" }} /></Form.Item>
          <Form.Item label="Ticket Date & Time" name="ticketDate"><DatePicker showTime format="DD/MM/YYYY HH:mm A" style={{ width: "100%" }} /></Form.Item>
          <Form.Item label="Arrival City" name="arrivalCity"><Input type="text" /></Form.Item> */}
